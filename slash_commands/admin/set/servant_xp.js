...
module.exports = {
    data: new SlashCommandSubcommandBuilder()
        .setName("servant_xp")
        .setDescription("Set xp to a servant")
        .addNumberOption(o => o.setName("xp").setRequired(true).setDescription("xp to set"))
    ...
    execute: async (interaction, _) => {
        ...
        const container = new ContainerBuilder().addTextDisplayComponents((t) => t.setContent(`Select a servant to set xp to **${xp}** !`)).addActionRowComponents(row)
