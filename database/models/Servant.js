...
class Servant extends Model {
    static init(sequelize) {
        return super.init({
            ...
            element: {
                type: DataTypes.ENUM('fire', 'water', 'earth', 'wind', 'electric', 'ice', 'light', 'dark', 'nature'),
                allowNull: false
            },
            role: {
                type: DataTypes.ENUM('dps', 'tank', 'healer', 'support', 'control', 'dps_aoe', 'dps_st'),
                allowNull: false
            },
            gender: {
