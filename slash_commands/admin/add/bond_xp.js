...
module.exports = {
    data: new SlashCommandSubcommandBuilder()
        .setName("bond_xp")
        .setDescription("Add bond xp to a servant")
        .addNumberOption(o => o.setName("xp").setRequired(true).setDescription("Bond xp to add"))
    ...
    execute: async (interaction, _) => {
        ...
        const container = new ContainerBuilder().addTextDisplayComponents((t) => t.setContent(`Select a servant to add **${xp}**  bond xp to !`)).addActionRowComponents(row)
        ...
        collector.on("end", async (i) => {
            if (servants.length !== 1) {
                ...
                servant.bondXp = Math.max(0, servant.bondXp + xp)
